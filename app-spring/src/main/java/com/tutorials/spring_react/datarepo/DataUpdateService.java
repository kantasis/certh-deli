...
public class DataUpdateService {
   ...
   private static final String importQuery_str = """
      COPY data_tbl(
         ...
         "Alcohol use SEV_lower",
         "Alcohol use SEV_upper",
         "Alcohol use SEV_val",
         "Diet high in processed meat SEV_lower",
         "Diet high in processed meat SEV_upper",
         "Diet high in processed meat SEV_val",
         "Diet high in red meat SEV_lower",
         "Diet high in red meat SEV_upper",
         "Diet high in red meat SEV_val",
         "Diet high in sodium SEV_lower",
         "Diet high in sodium SEV_upper",
         "Diet high in sodium SEV_val",
         "Diet high in sugar-sweetened beverages SEV_lower",
         "Diet high in sugar-sweetened beverages SEV_upper",
         "Diet high in sugar-sweetened beverages SEV_val",
         "Diet high in trans fatty acids SEV_lower",
         "Diet high in trans fatty acids SEV_upper",
         "Diet high in trans fatty acids SEV_val",
         "Diet low in calcium SEV_lower",
         "Diet low in calcium SEV_upper",
         "Diet low in calcium SEV_val",
         "Diet low in fiber SEV_lower",
         "Diet low in fiber SEV_upper",
         "Diet low in fiber SEV_val",
         "Diet low in fruits SEV_lower",
         "Diet low in fruits SEV_upper",
         "Diet low in fruits SEV_val",
         "Diet low in legumes SEV_lower",
         "Diet low in legumes SEV_upper",
         "Diet low in legumes SEV_val",
         "Diet low in milk SEV_lower",
         "Diet low in milk SEV_upper",
         "Diet low in milk SEV_val",
         "Diet low in nuts and seeds SEV_lower",
         "Diet low in nuts and seeds SEV_upper",
         "Diet low in nuts and seeds SEV_val",
         "Diet low in polyunsaturated fatty acids SEV_lower",
         "Diet low in polyunsaturated fatty acids SEV_upper",
         "Diet low in polyunsaturated fatty acids SEV_val",
         "Diet low in seafood omega-3 fatty acids SEV_lower",
         "Diet low in seafood omega-3 fatty acids SEV_upper",
         "Diet low in seafood omega-3 fatty acids SEV_val",
         "Diet low in vegetables SEV_lower",
         "Diet low in vegetables SEV_upper",
         "Diet low in vegetables SEV_val",
         "Diet low in whole grains SEV_lower",
         "Diet low in whole grains SEV_upper",
         "Diet low in whole grains SEV_val",
         "High body-mass index SEV_lower",
         "High body-mass index SEV_upper",
         "High body-mass index SEV_val",
         "Low physical activity SEV_lower",
         "Low physical activity SEV_upper",
         "Low physical activity SEV_val",
         "Smoking SEV_lower",
         "Smoking SEV_upper",
         "Smoking SEV_val",
         "Unsafe water source SEV_lower",
         "Unsafe water source SEV_upper",
         "Unsafe water source SEV_val",
