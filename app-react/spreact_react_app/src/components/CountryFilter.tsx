...
const CountryFilter: React.FC<FilterProps> = ({
   ...
   return (
      <>
        ...
        .cf-map-btn {
          font-size: 11px; color: var(--brand-dark, #185569); background: #e8f2f6;
        ...
        .cf-tag { display: inline-flex; align-items: center; gap: 5px; background: #e8f2f6; color: #185569; border-radius: 20px; padding: 3px 10px 3px 12px; font-size: 13px; font-weight: 500; animation: tagIn 0.18s ease; white-space: nowrap; }
        @keyframes tagIn { from { transform: scale(0.75); opacity: 0; } to { transform: scale(1); opacity: 1; } }
        .cf-tag-remove { display: flex; align-items: center; justify-content: center; width: 16px; height: 16px; border-radius: 50%; border: none; background: transparent; color: #1f6580; cursor: pointer; font-size: 14px; line-height: 1; padding: 0; transition: background 0.15s, color 0.15s; }
