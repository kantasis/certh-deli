...
const NutritionPanel: React.FC = () => {
   ...
   return (
      <>
         <style>{`
            .np-page { padding: 24px 0 40px; }
            .np-header { margin-bottom: 20px; padding-bottom: 16px; border-bottom: 1px solid var(--border, #e5e7eb); }
            .np-header h1 { font-size: 22px; font-weight: 800; color: var(--text, #0f172a); margin: 0 0 3px; }
            .np-header p { font-size: 14px; color: var(--text-muted, #475569); margin: 0; }
            .np-sidebar-card {
            ...
            .np-iframe-loading.hidden { opacity: 0; pointer-events: none; }
            .np-iframe-loading span { font-size: 14px; color: var(--text-muted, #475569); font-weight: 500; }
            .np-iframe { display: block; border: none; width: 100%; height: 600px; }
            @media (prefers-reduced-motion: reduce) { .np-iframe-loading { transition: none; } }
         `}</style>

         <div className="container-fluid np-page">
            ...
            <div className="row g-3">
               ...
               <div className="col-xl-8 col-lg-6">
                  <div className="np-iframe-wrapper">
                     {iframeLoading && (
                        <div className="np-iframe-loading">
                     ...
                     <iframe
                        ...
                        className="np-iframe"
                        src={iFrame_url}
                        title="Nutrition Risk Factors chart"
