...
COPY data_tbl(
	...
	"Age",
	"Sex",
	"Ambient ozone pollution_Rate_Summary exposure value_val",
	"Ambient particulate matter pollution_Rate_Summary exposure value_val",
	"Diet low in polyunsaturated fatty acids_Rate_Summary exposure value_val",
	"Diet high in processed meat_Rate_Summary exposure value_val",
	"Diet high in red meat_Rate_Summary exposure value_val",
	"Diet high in sodium_Rate_Summary exposure value_val",
	"Diet high in sugar-sweetened beverages_Rate_Summary exposure value_val",
	"Diet high in trans fatty acids_Rate_Summary exposure value_val",
	"Diet low in calcium_Rate_Summary exposure value_val",
	"Diet low in fiber_Rate_Summary exposure value_val",
	"Diet low in fruits_Rate_Summary exposure value_val",
	"Diet low in legumes_Rate_Summary exposure value_val",
	"Diet low in milk_Rate_Summary exposure value_val",
	"Diet low in nuts and seeds_Rate_Summary exposure value_val",
	"Diet low in seafood omega-3 fatty acids_Rate_Summary exposure value_val",
	"Diet low in vegetables_Rate_Summary exposure value_val",
	"Diet low in whole grains_Rate_Summary exposure value_val",
	"High LDL cholesterol_Rate_Summary exposure value_val",
	"Alcohol use_Rate_Summary exposure value_val",
	"High body-mass index_Rate_Summary exposure value_val",
	"High fasting plasma glucose_Rate_Summary exposure value_val",
	"High systolic blood pressure_Rate_Summary exposure value_val",
	"Household air pollution from solid fuels_Rate_Summary exposure value_val",
	"Kidney dysfunction_Rate_Summary exposure value_val",
	"Lead exposure_Rate_Summary exposure value_val",
	"Low physical activity_Rate_Summary exposure value_val",
	"Nitrogen dioxide pollution_Rate_Summary exposure value_val",
	"No access to handwashing facility_Rate_Summary exposure value_val",
	"Occupational asthmagens_Rate_Summary exposure value_val",
	"Occupational carcinogens_Rate_Summary exposure value_val",
	"Occupational ergonomic factors_Rate_Summary exposure value_val",
	"Occupational particulate matter, gases, and fumes_Rate_Summary exposure value_val",
	"Particulate matter pollution_Rate_Summary exposure value_val",
	"Residential radon_Rate_Summary exposure value_val",
	"Smoking_Rate_Summary exposure value_val",
	"Tobacco_Rate_Summary exposure value_val",
	"Unsafe sanitation_Rate_Summary exposure value_val",
	"Unsafe water source_Rate_Summary exposure value_val",
	"Unsafe water, sanitation, and handwashing_Rate_Summary exposure value_val",
	"Diabetes mellitus type 1_Prevalence_Rate",
	"Diabetes mellitus type 2_Prevalence_Rate",
	"Diabetes mellitus_Prevalence_Rate",
	"Inflammatory bowel disease_Prevalence_Rate",
	"CRC_DALYs_Rate",
	...
	"Alcohol use_Rate_Summary exposure value_lower",
	"Alcohol use_Rate_Summary exposure value_upper",
	"Diet high in processed meat_Rate_Summary exposure value_lower",
	"Diet high in processed meat_Rate_Summary exposure value_upper",
	"Diet high in red meat_Rate_Summary exposure value_lower",
	"Diet high in red meat_Rate_Summary exposure value_upper",
	"Diet high in sodium_Rate_Summary exposure value_lower",
	"Diet high in sodium_Rate_Summary exposure value_upper",
	"Diet high in sugar-sweetened beverages_Rate_Summary exposure value_lower",
	"Diet high in sugar-sweetened beverages_Rate_Summary exposure value_upper",
	"Diet high in trans fatty acids_Rate_Summary exposure value_lower",
	"Diet high in trans fatty acids_Rate_Summary exposure value_upper",
	"Diet low in calcium_Rate_Summary exposure value_lower",
	"Diet low in calcium_Rate_Summary exposure value_upper",
	"Diet low in fiber_Rate_Summary exposure value_lower",
	"Diet low in fiber_Rate_Summary exposure value_upper",
	"Diet low in fruits_Rate_Summary exposure value_lower",
	"Diet low in fruits_Rate_Summary exposure value_upper",
	"Diet low in legumes_Rate_Summary exposure value_lower",
	"Diet low in legumes_Rate_Summary exposure value_upper",
	"Diet low in milk_Rate_Summary exposure value_lower",
	"Diet low in milk_Rate_Summary exposure value_upper",
	"Diet low in nuts and seeds_Rate_Summary exposure value_lower",
	"Diet low in nuts and seeds_Rate_Summary exposure value_upper",
	"Diet low in polyunsaturated fatty acids_Rate_Summary exposure value_lower",
	"Diet low in polyunsaturated fatty acids_Rate_Summary exposure value_upper",
	"Diet low in seafood omega-3 fatty acids_Rate_Summary exposure value_lower",
	"Diet low in seafood omega-3 fatty acids_Rate_Summary exposure value_upper",
	"Diet low in vegetables_Rate_Summary exposure value_lower",
	"Diet low in vegetables_Rate_Summary exposure value_upper",
	"Diet low in whole grains_Rate_Summary exposure value_lower",
	"Diet low in whole grains_Rate_Summary exposure value_upper",
	"High body-mass index_Rate_Summary exposure value_lower",
	"High body-mass index_Rate_Summary exposure value_upper",
	"Low physical activity_Rate_Summary exposure value_lower",
	"Low physical activity_Rate_Summary exposure value_upper",
	"Smoking_Rate_Summary exposure value_lower",
	"Smoking_Rate_Summary exposure value_upper",
	"Unsafe water source_Rate_Summary exposure value_lower",
	"Unsafe water source_Rate_Summary exposure value_upper",
	"%_Percentage of the population unable to afford a healthy diet (percent)_Value",
	"PPP dollar per person per day_Cost of a healthy diet (PPP dollar per person per day)_Value",
	...
	"million No_Number of people unable to afford a healthy diet (million)_Value",
	"CRC_incidence_val_Number","CRC_incidence_upper_Number",
	...
	"Primary care costs β‚¬",
	"Percentage of total colorectal cancer health-care costs on Primary care",
	"Outpatient care costs β‚¬",
	"Percentage of total colorectal cancer health-care costs on Outpatient care",
	"Emergency care costs β‚¬",
	"Percentage of total colorectal cancer health-care costs on Emergency care",
	"Hospital care costs β‚¬",
	"Percentage of total colorectal cancer health-care costs on Hospital care",
	"Systemic anti-cancer therapy costs β‚¬",
	"Percentage of total colorectal cancer health-care costs on Systemic anti-cancer therapy",
	"Total health- care expenditure costs β‚¬",
	"Percentage of total colorectal cancer economic burden on health-care expenditure",
	"Mortality costs β‚¬",
	"Percentage of total colorectal cancer economic burden on Mortality",
	"Morbidity costs β‚¬",
	"Percentage of total colorectal cancer economic burden on Morbidity",
	"Informal care costs β‚¬",
	"Percentage of total colorectal cancer economic burden on Informal care",
	"Total non- health-care expenditure costs β‚¬",
	"Percentage of total colorectal cancer economic burden on non- health-care expenditure",
