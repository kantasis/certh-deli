...
POLICIES_RFILE="../shared/input/new_predictive.csv"

# Main

echo "---- GK> Copying the sql script"
docker cp "${POSTGRESCRIPTS_RPATH}/import_new_predictive.sql" "${PROJECT_NAME}_db_container:/"
